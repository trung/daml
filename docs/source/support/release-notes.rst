...
- Add documentation for the :doc:`DAML Integration Kit </daml-integration-kit/index>`. 
  This documentation explains what the DAML Integration Kit is, what state it
  is in (PRE-ALPHA), and how it is going to evolve.
